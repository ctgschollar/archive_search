...
//						console.log (append);
	...
	if (doc["Targets"]){
		...
		for (var i = 1; i < doc["Targets"].length; i++){
			...
			+ "<div id='dlg" + doc.id + "' class='confirm' value='" + doc.id + "&" + doc["CAS.ReferenceDatastore"] + "' title='Delete experiment " +  doc['ExperimentID'] +"?' style='text-align: center;'> Delete " + doc.Description + "?</div>"
			+ "</td></tr></table><br></div>";
